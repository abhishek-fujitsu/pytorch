...
if(INTERN_BUILD_ATEN_OPS)
  ...
  if(COMPILER_HAS_ARM_SVE)
    ...
    function(add_sve_flags SVE_BITS)
      set(CAP_NAME "SVE${SVE_BITS}")
      set(CAP_FLAG "-march=armv8-a+sve -DCPU_CAPABILITY_SVE -msve-vector-bits=${SVE_BITS}")

      if("${CMAKE_C_COMPILER_ID}" MATCHES "Clang")
        set(CAP_FLAG "${OPT_FLAG} -O2 ${CAP_FLAG}")
      else()
        set(CAP_FLAG "${OPT_FLAG} ${CAP_FLAG}")
      endif()

      set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DHAVE_${CAP_NAME}_CPU_DEFINITION")
      list(APPEND CPU_CAPABILITY_NAMES "${CAP_NAME}")
      list(APPEND CPU_CAPABILITY_FLAGS "${CAP_FLAG}")
    endfunction()
